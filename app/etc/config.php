...
return [
    'modules' => [
        ...
        'Amasty_SpecialPromotionsLite' => 0,
        'Amazon_Pay' => 0,
        ...
        'Graycore_Cors' => 1,
        'Hryvinskyi_Base' => 1,
        'Hryvinskyi_QuoteAddressValidator' => 1,
        'Jajuma_WebpImages' => 1,
        'JetRails_Cloudflare' => 1,
        'Kartbutikken_B2BCustomerHasInvoiceEmail' => 1,
        'Kartbutikken_B2bRegistration' => 1,
        'Kartbutikken_Catalog' => 1,
        'Kartbutikken_Customer' => 1,
        'Kartbutikken_NordecakonsumentOrderAttributes' => 1,
        'Kartbutikken_Theme' => 1,
        'Kartbutikken_ThemeCsp' => 0,
        'Kartbutikken_WebsiteLocator' => 1,
        'Kartbutikken_WeltPixelCatalogWidget' => 1,
        'Klarna_Base' => 1,
        'Klarna_Backend' => 1,
        'Klarna_Kco' => 1,
        'Klarna_Keb' => 1,
        ...
        'Klarna_Orderlines' => 1,
        'Klarna_Support' => 1,
        'MageCloud_AllowHtmlTag' => 1,
        'MageCloud_AmastyGdpr' => 1,
        'MageCloud_AutoInvoice' => 1,
        'MageCloud_AutoUpdateCartItemQty' => 1,
        'MageCloud_BaseSeoChanges' => 1,
        'MageCloud_CmsPage' => 1,
        'MageCloud_Cors' => 1,
        'MageCloud_Csp' => 1,
        'MageCloud_CurrencySettings' => 1,
        'MageCloud_Discountpercentage' => 1,
        'MageCloud_EnhancedEcommerce' => 0,
        'MageCloud_FixMageplazaLayeredNavigationAndMirasvitSearchAutoCompleate' => 1,
        'MageCloud_Gallery' => 1,
        'MageCloud_HideDefaultStoreCode' => 1,
        'MageCloud_HideShippingWhenEmptyZip' => 1,
        'MageCloud_ImageLazyLoad' => 1,
        'MageCloud_MagePalGoogleTagManagerCsp' => 0,
        'MagicToolbox_MagicZoomPlus' => 1,
        'MageCloud_NoResultViewModel' => 1,
        'MageCloud_OptimizeXMagentoInit' => 1,
        'MageCloud_OrderEmailCopy' => 1,
        'MageCloud_ReadMore' => 1,
        'MageCloud_ReorderProduct' => 1,
        'MageCloud_Sales' => 1,
        'Mageplaza_Core' => 1,
        'MageCloud_SnowdogMenuWidget' => 1,
        'MageCloud_VideoWidget' => 1,
        'WeltPixel_Backend' => 1,
        'MagePal_Core' => 1,
        ...
        'Magestat_LogWebapi' => 1,
        'MagicToolbox_MagicScroll' => 1,
        'MageCloud_MagicZoomPlus' => 1,
        'Mirasvit_Core' => 1,
        'Mirasvit_Feed' => 1,
        'Mirasvit_Report' => 1,
        'PayPal_Braintree' => 1,
        ...
        'MageCloud_WeltPixelOwlCarouselSlider' => 1
    ]
];

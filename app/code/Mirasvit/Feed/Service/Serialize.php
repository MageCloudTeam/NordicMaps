...
class Serialize
{
    ...
    public function serialize($data)
    {
        ...
        return $this->serializer ? $this->serializer->serialize($data) : \Laminas\Json\Json::encode($data);
    }
    ...
    public function unserialize($string)
    {
        ...
        try {
            $result = $this->serializer ? $this->serializer->unserialize($string) : \Laminas\Json\Json::decode($string);
        } catch (\Exception $e) {
            /** mp comment start **/

...
class SeriesProcess extends \Magento\Framework\App\Config\Value
{
    /**
    ...
    public function beforeSave()
    {
        ...
        foreach ($value as $data) {
            if (
                ...
                empty($data[Config::RULE_EMAIL_COPY_OF_ORDER])
            ) {
                continue;
            }

            $result[] = [
                Config::RULE_DESTINATION_STATUS    => $data[Config::RULE_DESTINATION_STATUS][0],
                Config::RULE_EMAIL_COPY_OF_ORDER => $data[Config::RULE_EMAIL_COPY_OF_ORDER],
            ];
    ...
    protected function encodeArrayFieldValue(array $value)
    {
        ...
        foreach ($value as $key => $item) {
            ...
            if (is_array($item)) {
                ...
                $emailCopyOfInvoice = $item[Config::RULE_EMAIL_COPY_OF_ORDER];
            } else {
            ...
            $result[$id] = [
                ...
                Config::RULE_EMAIL_COPY_OF_ORDER => $emailCopyOfInvoice,
            ];
        }

...
namespace MageCloud\FixMageplazaLayeredNavigationAndMirasvitSearchAutoCompleate\Model\ResourceModel\Fulltext;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    protected function _renderFiltersBefore()
    {
        ...
        if ($this->searchRequestName !== 'quick_search_container'
            ...
            if (
                ...
                $this->request->getFullActionName() === 'searchautocomplete_ajax_suggest'
            ) {
    ...
    {
        return preg_replace('/[0-9]+/', '', $this->_scopeConfig->getValue(Custom::XML_PATH_CATALOG_SEARCH_ENGINE, ScopeInterface::SCOPE_STORE));
    }
}

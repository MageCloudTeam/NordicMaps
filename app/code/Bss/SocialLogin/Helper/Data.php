...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        if ($this->getConfig('bss_sociallogin/button_social/login_byclass')) {
            $bssDisplayButtonLogin = $this->getConfig('bss_sociallogin/button_social/login_byclass');
        } else {
            $bssDisplayButtonLogin = "";
        }
        return explode(',', $bssDisplayButtonLogin);
    }
    ...
    {
        if ($this->getConfig('bss_sociallogin/button_social/register_byclass')) {
            $bssDisplayConfigRegister = $this->getConfig('bss_sociallogin/button_social/register_byclass');
        } else {
            $bssDisplayConfigRegister = "";
        }
        return explode(',', $bssDisplayConfigRegister);
    }

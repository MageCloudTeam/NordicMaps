...
class Cart extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getProductAndParamList()
    {
        ...
        foreach ($productIds as $key => $productId) {
            ...
            $params['options'] = $this->addCustomOption($product, $fastorderCustomOption, $key);
     ...
     * @param  $params
     * @param  null $product
     * @param  null $fastorderSuperAttribute
     * @param  null $fastorderLinks
     * @param  null $fastorderSuperGroup
     * @param  null $key
     * @return bool
     */
    protected function addOptionProduct(
        ...
        if ($product->getTypeId() == 'configurable' && !empty($fastorderSuperAttribute) && !empty($fastorderSuperAttribute[$key])) {
    ...
    /**
     * @param array $fastorderCustomOption
     * @param int|null $key
     * @param \Magento\Catalog\Model\Product $product
     * @return mixed
     */
    protected function addCustomOption(\Magento\Catalog\Model\Product $product, array $fastorderCustomOption = null, int $key = null)
    {

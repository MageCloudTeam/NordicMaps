...
class ConfigurableProduct extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    public function getChildProductData($parentProductId, $productListParams)
    {
        // get parent product
        $parentProduct = $this->getProductRepositoryInterface()->getById($parentProductId);
        $productSkuList = array_column($productListParams, 'sku');
        ...
        foreach ($productListParams as $productParam) {
            $childProduct = $this->getProductRepositoryInterface()->get($productParam['sku']);

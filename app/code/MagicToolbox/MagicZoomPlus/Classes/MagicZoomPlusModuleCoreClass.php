...
class MagicZoomPlusModuleCoreClass
{
    ...
    public function getHeadersTemplate($jsPath = '', $cssPath = null)
    {
        ...
        $headers = [];
        $headers[] = '<!-- Magic Zoom Plus Magento 2 module version v1.6.4 [v1.6.90:v5.3.5] -->';
    ...
    public function getSelectorTemplate($params)
    {
        ...
        return "<a data-zoom-id=\"MagicZoomPlusImage{$id}\" href=\"{$img}\" {$medium2x} data-image=\"{$medium}\"{$title}><img class='no-lazy' data-nowebp=\"true\" src=\"{$thumb}\" {$thumb2x} alt=\"{$alt}\"{$width}{$height} /></a>";
    }

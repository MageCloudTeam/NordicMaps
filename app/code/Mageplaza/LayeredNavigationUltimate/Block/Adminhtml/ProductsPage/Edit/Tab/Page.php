...
use Mageplaza\LayeredNavigationUltimate\Model\Config\Source\CmsPosition;
use Mageplaza\LayeredNavigationUltimate\Model\Config\Source\CmsBlock;
...
class Page extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('cms_position', 'select', [
            'name' => 'cms_position',
            'label' => __('CMS Block Display Position'),
            'title' => __('CMS Block Display Position'),
            'values' => $this->cmsPosition->toOptionArray(),
            'note' => __('Select the display position of CMS Block at Custom Product Pages of Layered Navigation')
        ]);
        $fieldset->addField('cms_block', 'select', [
            'name' => 'cms_block',
            'label' => __('CMS Block'),
            'title' => __('CMS Block'),
            'values' => $this->cmsBlock->toOptionArray()
        ]);
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock(Dependence::class)
                ->addFieldMap('page_cms_position', 'cms_position')
                ->addFieldMap('page_cms_block', 'cms_block')
                ->addFieldDependence('cms_block', 'cms_position', $refField)
        );

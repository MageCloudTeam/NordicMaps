    ...
    private function convertToWebpViaCwebp($imagePath, $webpPath)
    {
        if ($this->helper->isExecFunctionEnabled()) {
            ...
            try {
                ...
                $this->error = __('Conversion Failed. Please make sure your custom path and command are correct and your quality configuration value is between 0 and 100!') . $exception->getMessage();
                return false;
            }

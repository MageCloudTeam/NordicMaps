 ...
 * @internal
 */
class BundledFixedTest extends RequestBuilderTestCase
{
    ...
    /**
     * @magentoDataFixture Klarna_Base::Test/Integration/_files/fixtures/product_bundled_fixed.php
     * @magentoDataFixture Klarna_Base::Test/Integration/_files/fixtures/product_bundled_fixed_two.php
     * @magentoDataFixture Klarna_Base::Test/Integration/_files/fixtures/tax_rule_us_postal_36104.php
     *
     * @magentoConfigFixture current_store tax/classes/shipping_tax_class 2
     *
    ...
    public function testMultipleDifferentProductsForShopSetup1()
    {
        ...
        $productOne = $this->productRepository->get('bundle-product');
        $quote->addProduct($productOne);

        $productTwo = $this->productRepository->get('bundle-product-two');

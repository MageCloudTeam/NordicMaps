...
class Order
{
    ...
    public function createMagentoOrder(string $klarnaOrderId): MagentoOrderInterface
    {
        ...
        try {
            ...
            $this->klarnaOrder = $this->orderRepository->createEmptyOrder();
    ...
    public function cancelKlarnaOrder(string $klarnaOrderId, string $cancelReason): void
    {
        ...
        try {
            ...
            if ($order->getStatus() !== 'CANCELED') {
                ...
                $this->logger->forceLogging('Canceled order with Klarna - ' . $cancelReason);
            }
        } catch (\Exception $e) {
            $this->logger->logException($e);
        }
    ...
    public function updateOrderState(string $klarnaOrderId): void
    {
        ...
        $omApi = $this->factory->createOmApi($this->mageOrder->getPayment()->getMethod(), $this->mageOrder->getStore());

...
class SettingsProvider
{
     ...
     */
    public function isPackstationSupport(StoreInterface $store): bool
    {
        return (bool)$this->klarnaConfig->getVersionConfig($store)->isPackstationSupport();
    }
    ...
    {
        if ($this->klarnaConfig->getVersionConfig($store)->isShippingInIframe()) {
            return $this->isCheckoutConfigFlag('shipping_in_iframe', $store);
        }
        return false;
    }

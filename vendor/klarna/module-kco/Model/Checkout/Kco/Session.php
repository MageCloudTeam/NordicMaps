...
class Session
{
    ...
    public function getKlarnaQuote(): ?QuoteInterface
    {
        ...
        try {
            ...
            $this->klarnaQuote = $this->createNewKlarnaQuote();
        }
    ...
    public function setKlarnaQuoteKlarnaCheckoutId($klarnaCheckoutId)
    {
        ...
        if (!$klarnaQuote->getId()) {
            $klarnaQuote = $this->createNewKlarnaQuote($klarnaCheckoutId);
        }
        if ($klarnaQuote->getKlarnaCheckoutId() === null) {
     ...
     */
    private function createNewKlarnaQuote($klarnaCheckoutId = null)
    {
        $data = [

...
class Capture extends AbstractCommand
{
    ...
    public function execute(array $commandSubject)
    {
        ...
        $this->validator->checkRequestSendable($klarnaOrder, $magentoOrder, $this->validator::ACTION_TYPE_CAPTURE);
        ...
        $this->validator->checkApiResponse(
            $klarnaOrder,
            $response,
            $magentoOrder,
            $this->validator::ACTION_TYPE_CAPTURE
        );
